...
export function Latest() {
  ...
  return (
    <div className="flex flex-col border border-1 w-[1200px] aspect-[1.91/1] p-4 md:p-12">
      ...
      <div className="flex relative grow w-auto h-auto justify-center items-center my-4">
        ...
        <div className="absolute -mt-32 ml-72">
            <div className={`flex text-xs items-center p-1 rounded-xl ${data.difference >= 0 ? 'badge-success fill-green-900 text-green-900' : 'badge-error fill-red-900 text-red-900'}`}>
